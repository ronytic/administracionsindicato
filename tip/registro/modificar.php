    	...
    	<div class="prefix_1 grid_8 alpha">
			<fieldset>
				...
				<table class="tablareg">
					...
					<tr>
						<td><?php campos("Placa","placa","text",$t['placa'],1,array("required"=>"required","size"=>20));?></td>
                    ...
                    <tr>
						<td><?php campos("Poliza de Seguro","polizaseguro","text",$t['polizaseguro'],1,array("required"=>"required","size"=>20));?></td>
                        <td><?php campos("Marca","marca","text",$t['marca'],0,array("size"=>40));?></td>
                        <td><?php campos("Modelo","modelo","text",$t['modelo'],0,array("size"=>30));?></td>
					</tr>
                    <tr>
						<td><?php campos("Color","color","text",$t['color'],1,array("required"=>"required","size"=>20));?></td>
                    ...
                    <tr>
						<td><?php campos("Nº de Motor","nmotor","text",$t['nmotor'],1,array("required"=>"required","size"=>20));?></td>
                ...
                <table class="tablareg">
                    ...
                    <tr>
						<td><?php campos("Categoria de la Licencia","categoriaconductor","select",$categoria,1,array("required"=>"required","size"=>20),$t['categoriaconductor']);?></td>
